  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="使用状态" prop="status">
        ...
        >
          <el-option
            v-for="dict in dict.type.pms_zone_status"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['parking:zone:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['parking:zone:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
    ...
    >
      ...
      <el-table-column label="分区车位数" align="center" prop="total" />
      <el-table-column label="分区位置" align="center" prop="location" />
      <el-table-column label="使用状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag
            :options="dict.type.pms_zone_status"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="车位数" prop="total">
          <el-input-number v-model="form.total" :min="0" />
        </el-form-item>
        <el-form-item label="分区位置" prop="location">
          <el-input v-model="form.location" placeholder="请输入分区位置" />
        </el-form-item>
        <el-form-item label="使用状态" prop="status">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        name: [
          { required: true, message: "分区名称不能为空", trigger: "change" },
        ],
        total: [
          { required: true, message: "分区车位数不能为空", trigger: "change" },
        ],
      },
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除分区管理编号为"' + zoneIds + '"的数据项？')
        .then(function () {
