...
import com.ruoyi.common.mqtt.properties.MqttProperties;
...
public class MqttConsumerCallback implements MqttCallbackExtended {
    ...
    public void connectionLost(Throwable throwable) {
        ...
        if (MqttConsumer.client == null || !MqttConsumer.client.isConnected()) {
            logger.info("【emqx重新连接】....................................................");
            mqttConsumer.reconnection();
        }
    }
    ...
    public void connectComplete(boolean b, String s) {
        logger.info("============================= 客户端【" + MqttConsumer.client.getClientId() + "】连接成功！=============================");
        // 以/#结尾表示订阅所有以test开头的主题
        // 订阅所有机构主题
        mqttConsumer.subscribe(mqttProperties.getDefaultTopic(), 0);
    }
